...
export class BookLibrary {
    ...
    @ManyToOne(() => Book, (book) => book.isbn) @JoinColumn({ name: 'book_id'}) public book: Book;
    @ManyToOne(() => Library, (library) => library.id) @JoinColumn({ name: 'library_id'}) public library: Library;
}